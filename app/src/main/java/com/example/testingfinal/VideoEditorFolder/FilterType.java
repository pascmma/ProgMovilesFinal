...
import com.example.testingfinal.VideoEditorFolder.filter.GlBitmapOverlaySample;
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            case LOOK_UP_TABLE_SAMPLE:
                Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.gato);
            ...
            case WATERMARK:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.gato), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:
            ...
            case BITMAP_OVERLAY_SAMPLE:
                return new GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.gato));
            default:
                return new GlFilter();
        }
    }
